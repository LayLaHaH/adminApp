// ignore_for_file: library_private_types_in_public_api, prefer_typing_uninitialized_variables, prefer_const_constructors, use_build_context_synchronously, file_names, avoid_print
    ...
    //sending the create request
      final response1 = await http.post(
        ...
        body: <String, String>{
          ...
          'closingHour': _closingHourController.toIso8601String(),
